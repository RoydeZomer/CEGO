...
For example, one use case would be to optimize expensive objectives that need to be computed with simulations. See the following paper http://doi.org/10.1007%2F978-3-030-13709-0_16 and master thesis for more detail about this algorithm:  
